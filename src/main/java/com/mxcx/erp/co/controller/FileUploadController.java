 ...
 */
@Controller
@RequestMapping("/manager/erp/co/upload.do")
public class FileUploadController {
	...
	private static final String FOR_FREEMARKER_LOAD_DIR = "/co/";
	/** ~~~ 上传文件的最大文件大小 */
	...
	public void processUploadPost(ModelMap modelMap,
		...
		try {
			...
			String fileClientName = this.systemUpload.systemUpload(request,
					"uploadFile", FilePath.CO_CONTENT_UPLOAD_FILE_PATH.filePath+timedate);
