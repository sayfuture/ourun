...
_15(e,"mousedown");
if($.fn.dragable.isDragging||$.fn.resizable.isResizing){
e.preventDefault();
}
};
function _16(e){
...
(function($){
function _1b(e){
var _1c=$.data(e.data.target,"dragable");
var _1d=_1c.options;
var _1e=_1c.proxy;
var _1f=e.data;
...
function _21(e){
var _22=$.data(e.data.target,"dragable");
var _23=_22.options;
var _24=_22.proxy;
if(!_24){
_24=$(e.data.target);
...
function _25(e){
$.fn.dragable.isDragging=true;
var _26=$.data(e.data.target,"dragable");
var _27=_26.options;
...
function _2b(e){
var _2c=$.data(e.data.target,"dragable");
_1b(e);
...
function _2f(e){
$.fn.dragable.isDragging=false;
_2b(e);
var _30=$.data(e.data.target,"dragable");
var _31=_30.proxy;
var _32=_30.options;
if(_32.revert){
if(_33()==true){
...
$.fn.dragable=function(_38,_39){
if(typeof _38=="string"){
return $.fn.dragable.methods[_38](this,_39);
}
return this.each(function(){
var _3a;
var _3b=$.data(this,"dragable");
if(_3b){
_3b.handle.unbind(".dragable");
_3a=$.extend(_3b.options,_38);
}else{
_3a=$.extend({},$.fn.dragable.defaults,$.fn.dragable.parseOptions(this),_38||{});
}
var _3c=_3a.handle?(typeof _3a.handle=="string"?$(_3a.handle,this):_3a.handle):$(this);
$.data(this,"dragable",{options:_3a,handle:_3c});
if(_3a.disabled){
$(this).css("cursor","");
return;
}
_3c.unbind(".dragable").bind("mousemove.dragable",{target:this},function(e){
if($.fn.dragable.isDragging){
return;
}
var _3d=$.data(e.data.target,"dragable").options;
if(_3e(e)){
$(this).css("cursor",_3d.cursor);
}else{
$(this).css("cursor","");
}
}).bind("mouseleave.dragable",{target:this},function(e){
$(this).css("cursor","");
}).bind("mousedown.dragable",{target:this},function(e){
if(_3e(e)==false){
return;
}
$(this).css("cursor","");
...
$.extend(e.data,_41);
var _42=$.data(e.data.target,"dragable").options;
if(_42.onBeforeDrag.call(e.data.target,e)==false){
return;
}
$(document).bind("mousedown.dragable",e.data,_25);
$(document).bind("mousemove.dragable",e.data,_2b);
$(document).bind("mouseup.dragable",e.data,_2f);
});
function _3e(e){
var _43=$.data(e.data.target,"dragable");
var _44=_43.handle;
var _45=$(_44).offset();
...
$.fn.dragable.methods={options:function(jq){
return $.data(jq[0],"dragable").options;
},proxy:function(jq){
return $.data(jq[0],"dragable").proxy;
},enable:function(jq){
return jq.each(function(){
$(this).dragable({disabled:false});
});
},disable:function(jq){
return jq.each(function(){
$(this).dragable({disabled:true});
});
}};
$.fn.dragable.parseOptions=function(_48){
var t=$(_48);
...
$.fn.dragable.defaults={proxy:null,revert:false,cursor:"move",deltaX:null,deltaY:null,handle:null,disabled:false,edge:0,axis:null,onBeforeDrag:function(e){
...
_c6.disabledNodes=[];
_c7.dnd=true;
_c8.find("div.tree-node").dragable({disabled:false,revert:true,cursor:"pointer",proxy:function(_c9){
...
$(this).dragable("proxy").css({left:-10000,top:-10000});
...
var _db=$(_d9).dragable("proxy").find("span.tree-dnd-icon");
...
_248.window.dragable({handle:">div.panel-header>div.panel-title",disabled:_248.options.dragable==false,onStartDrag:function(e){
if(_248.mask){
...
return $.extend({},$.fn.panel.parseOptions(_251),$.parser.parseOptions(_251,[{dragable:"boolean",resizable:"boolean",shadow:"boolean",modal:"boolean",inline:"boolean"}]));
};
$.fn.window.defaults=$.extend({},$.fn.panel.defaults,{zIndex:9000,dragable:true,resizable:true,shadow:true,modal:false,inline:false,title:"New Window",collapsible:true,minimizable:true,maximizable:true,closable:true,closed:false});
})(jQuery);
(function($){
function _252(_253){
...
function _26f(_270){
var opts=$.extend({},$.fn.window.defaults,{collapsible:false,minimizable:false,maximizable:false,shadow:false,dragable:false,resizable:false,closed:true,style:{left:"",top:"",right:0,zIndex:$.fn.window.defaults.zIndex++,bottom:-document.body.scrollTop-document.documentElement.scrollTop},onBeforeOpen:function(){
...
var _511=$("<div class=\"datagrid-wrap\">"+"<div class=\"datagrid-view111\">"+"<div class=\"datagrid-view1\">"+"<div class=\"datagrid-header\">"+"<div class=\"datagrid-header-inner\"></div>"+"</div>"+"<div class=\"datagrid-body\">"+"<div class=\"datagrid-body-inner\"></div>"+"</div>"+"<div class=\"datagrid-footer\">"+"<div class=\"datagrid-footer-inner\"></div>"+"</div>"+"</div>"+"<div class=\"datagrid-view2\">"+"<div class=\"datagrid-header\">"+"<div class=\"datagrid-header-inner\"></div>"+"</div>"+"<div class=\"datagrid-body\"></div>"+"<div class=\"datagrid-footer\">"+"<div class=\"datagrid-footer-inner\"></div>"+"</div>"+"</div>"+"</div>"+"</div>").insertAfter(_50c);
...
_92a.find("a.slider-handle").dragable({axis:opts.mode,cursor:"pointer",disabled:opts.disabled,onDrag:function(e){
